 ...
 *  the answer is TRUE.
 *
 *  The macro name "OLDLAND_HAS_FPU" should be made CPU specific.
 ...
 *  OLDLAND Specific Information:
 *
 *  It is highly unlikely the OLDLAND will get used in a multiprocessor system.
 */
